...
public:
    ...
    void switchTrack(S32 trackno, const LLSettingsBase::TrackPosition& position);

	inline S32 getTrack() const					{ return mTrackNo; }

protected:
	LLSettingsDay::TrackBound_t getBoundingEntries(LLSettingsDay::CycleTrack_t &track, const LLSettingsBase::TrackPosition& keyframe);
