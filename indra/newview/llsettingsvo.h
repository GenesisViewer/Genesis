...
private:
    ...
    static void     onAssetDownloadComplete(LLVFS *vfs,const LLUUID &asset_id, LLAssetType::EType type,S32 status, LLExtStat ext_status, LLSettingsVOBase::asset_download_fn callback);
};
