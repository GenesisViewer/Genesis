...
// [/RLVa:KB]
		...
		LLAgentUI::buildLocationString(pos_string, gSavedSettings.getBOOL("GenesisLegacyLandmarks") ? LLAgentUI::LOCATION_FORMAT_NO_MATURITY : LLAgentUI::LOCATION_FORMAT_LANDMARK);
