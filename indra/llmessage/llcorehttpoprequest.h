...
// HttpOpRequestCompare is not an operation but a uniform comparison functor
// for STL containers that order by priority. Mainly used for the ready queue
// container but defined here.
class HttpOpRequestCompare
{
public:
	LL_INLINE bool operator()(const HttpOpRequest* lhs,
							  const HttpOpRequest* rhs)
	{
