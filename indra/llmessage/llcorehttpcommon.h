...
struct HttpStatus
{
	...
	inline HttpStatus(const HttpStatus& rhs)
	{
	...
	inline HttpStatus& operator=(const HttpStatus& rhs)
	{
		mDetails = rhs.mDetails;
		return *this;
	}

	inline HttpStatus& clone(const HttpStatus& rhs)
    {
	...
	inline bool operator==(const HttpStatus& rhs) const
	{
	...
	operator U32() const;
	inline U32 toULong() const				{ return operator U32(); }
	...
	// (100 - 999).
	inline bool isHttpStatus() const
	{
