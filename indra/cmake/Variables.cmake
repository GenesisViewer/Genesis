...
set(TEMPLATE_VERIFIER_MASTER_URL "" CACHE STRING "Location of the master message template")
...
if (DEFINED ENV{VIEWER_CHANNEL_BASE})
  ...
  set(VIEWER_CHANNEL_BASE "Genesis" CACHE STRING "Viewer Channel Base Name")
endif()

#set (VIEWER_CHANNEL_TYPE "" CACHE STRING "Viewer Channel Type Name" FORCE)

if (DEFINED ENV{VIEWER_CHANNEL_TYPE} OR DEFINED ${VIEWER_CHANNEL_TYPE})
