...
// [/RLVa:KB]
	...
	case IM_BUSY_AUTO_RESPONSE:
		...
		{
			gIMMgr->addMessage(session_id, from_id, name, separator_string + message.substr(message_offset), name, dialog, parent_estate_id, region_id, position, true,timestamp);
		}
		break;
