...
// HttpOpSetPriority is an immediate request that searches the various queues,
// looking for a given request handle and changing its priority if found.
//
// *NOTE: This will very likely be removed in the near future when priority is
...
public:
	...
	HttpOpSetPriority(const HttpOpSetPriority&) = delete;
	void operator=(const HttpOpSetPriority&) = delete;
