...
public:
	...
	//
	HttpHandle requestGet(policy_t policy_id, priority_t priority,
	...
	// @return				"
	//
	HttpHandle requestGetByteRange(policy_t policy_id, priority_t priority,
								   const std::string& url,
	...
	// @return				"
	//
	HttpHandle requestPost(policy_t policy_id, priority_t priority,
	...
	// @return				"
	//
	HttpHandle requestPut(policy_t policy_id, priority_t priority,
						  const std::string& url, BufferArray* body,
						  const HttpOptions::ptr_t& options,
						  const HttpHeaders::ptr_t& headers,
						  HttpHandler::ptr_t handler);
	...
	// @return					"
	//
	HttpHandle requestDelete(policy_t policy_id, priority_t priority,
							 const std::string& url,
							 const HttpOptions::ptr_t& options,
							 const HttpHeaders::ptr_t& headers,
	...
	// @return					"
	//
	HttpHandle requestPatch(policy_t policy_id, priority_t priority,
							const std::string& url, BufferArray* body,
							const HttpOptions::ptr_t& options,
							const HttpHeaders::ptr_t& headers,
							HttpHandler::ptr_t user_handler);
	...
	// @return					"
	//
	HttpHandle requestCopy(policy_t policy_id, priority_t priority,
						   const std::string& url,
						   const HttpOptions::ptr_t& options,
						   const HttpHeaders::ptr_t& headers,
						   HttpHandler::ptr_t user_handler);
	...
	// @return					"
	//
	HttpHandle requestMove(policy_t policy_id, priority_t priority,
						   const std::string& url,
						   const HttpOptions::ptr_t& options,
						   const HttpHeaders::ptr_t& headers,
						   HttpHandler::ptr_t user_handler);
	...
	// Request that a previously-issued request be reprioritized. The status of
	// whether the change itself succeeded arrives via notification.
	//
	// @param	request		Handle of previously-issued request to be changed.
	// @param	priority	New priority value.
	// @param	handler		@see requestGet()
	// @return				"
	//
	HttpHandle requestSetPriority(HttpHandle request, priority_t priority,
								  HttpHandler::ptr_t handler);
